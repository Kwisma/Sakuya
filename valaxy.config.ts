...
export default defineValaxyConfig<UserThemeConfig>({
  ...
  addons: [
    ...
    addonWaline({
      ...
      // 表情设置
      emoji: [
        'https://github.elemecdn.com/@waline/emojis@1.0.1/alus',
        'https://github.elemecdn.com/@waline/emojis@1.0.1/bilibili',
        'https://github.elemecdn.com/@waline/emojis@1.0.1/bmoji',
        'https://github.elemecdn.com/@waline/emojis@1.0.1/coolapk',
        'https://github.elemecdn.com/@waline/emojis@1.0.1/coolapk_coin',
        'https://github.elemecdn.com/@waline/emojis@1.0.1/qq',
        'https://github.elemecdn.com/@waline/emojis@1.0.1/soul-emoji',
        'https://github.elemecdn.com/@waline/emojis@1.0.1/tieba',
        'https://github.elemecdn.com/@waline/emojis@1.0.1/tw-body',
        'https://github.elemecdn.com/@waline/emojis@1.0.1/tw-emoji',
        'https://github.elemecdn.com/@waline/emojis@1.0.1/tw-flag',
        'https://github.elemecdn.com/@waline/emojis@1.0.1/tw-food',
        'https://github.elemecdn.com/@waline/emojis@1.0.1/tw-natural',
        'https://github.elemecdn.com/@waline/emojis@1.0.1/tw-object',
        'https://github.elemecdn.com/@waline/emojis@1.0.1/tw-people',
        'https://github.elemecdn.com/@waline/emojis@1.0.1/tw-sport',
        'https://github.elemecdn.com/@waline/emojis@1.0.1/tw-symbol',
        'https://github.elemecdn.com/@waline/emojis@1.0.1/tw-time',
        'https://github.elemecdn.com/@waline/emojis@1.0.1/tw-travel',
        'https://github.elemecdn.com/@waline/emojis@1.0.1/tw-weather',
