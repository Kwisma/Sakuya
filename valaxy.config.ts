  ...
  addons: [
    ...
    addonWaline({
      ...
      emoji: [
        ...
        'https://cdn.jsdelivr.net/npm/@waline/emojis@1.3.0/coolapk',
        'https://cdn.jsdelivr.net/npm/@waline/emojis@1.3.0/coolapk_coin',
        ...
        'https://cdn.jsdelivr.net/npm/@waline/emojis@1.3.0/tw-body',
        'https://cdn.jsdelivr.net/npm/@waline/emojis@1.3.0/tw-emoji',
        'https://cdn.jsdelivr.net/npm/@waline/emojis@1.3.0/tw-flag',
        'https://cdn.jsdelivr.net/npm/@waline/emojis@1.3.0/tw-food',
        'https://cdn.jsdelivr.net/npm/@waline/emojis@1.3.0/tw-natural',
        'https://cdn.jsdelivr.net/npm/@waline/emojis@1.3.0/tw-object',
        'https://cdn.jsdelivr.net/npm/@waline/emojis@1.3.0/tw-people',
        'https://cdn.jsdelivr.net/npm/@waline/emojis@1.3.0/tw-sport',
        'https://cdn.jsdelivr.net/npm/@waline/emojis@1.3.0/tw-symbol',
        'https://cdn.jsdelivr.net/npm/@waline/emojis@1.3.0/tw-time',
        'https://cdn.jsdelivr.net/npm/@waline/emojis@1.3.0/tw-travel',
        'https://cdn.jsdelivr.net/npm/@waline/emojis@1.3.0/tw-weather',
        'https://cdn.jsdelivr.net/npm/@waline/emojis@1.3.0/tw',
